...
function showData(jsonObj) {
  ...
  for (var i = 0; i < activiteiten.length; i++) {
    ...
    activiteitenDetails.textContent =
      activiteiten[i].details.nl.shortdescription;
    var activiteitenlocation = document.createElement("p");
    activiteitenlocation.textContent =
      activiteiten[i].location.adress + ", " + activiteiten[i].location.city;
